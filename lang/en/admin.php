...
return [
    ...
    'calendar_labels' => [
        ...
        'daily_schedule'   => 'Daily session schedule',
    ...
    'calendar_navigation' => [
        'day'              => 'Day navigation',
        'week_days'        => 'Select a day of the week',
    ...
    'calendar_filters' => [
        ...
        'by_teacher'       => 'Select by teacher',
        'by_student'       => 'Select by student',
        'by_room'          => 'Select by room',
        'by_instrument'    => 'Select by instrument',
    ],
    'calendar_errors' => [
        'loading_calendar' => 'The calendar could not be loaded.',
        'loading_sessions' => 'Error loading sessions',
        'invalid_events'   => 'The session data cannot be displayed.',
    ],
    'calendar_aria' => [
        'close_details'    => 'Close session details',
        'timeline'         => 'Session timeline',
