...
return [
    ...
    // ── Leads (CRM) ────────────────────────────────────────────────────────
    'manage_leads'                  => 'مدیریت سرنخ‌های آموزشگاه.',
    'new_lead'                       => 'سرنخ جدید',
    'create_lead'                    => 'ثبت سرنخ',
    'update_lead'                    => 'ذخیره تغییرات',
    'edit_lead'                      => 'ویرایش سرنخ',
    'register_lead_desc'             => 'اطلاعات سرنخ جدید را وارد کنید.',
    'update_lead_desc'               => 'اطلاعات سرنخ را ویرایش کنید.',
    'lead_full_name_placeholder'     => 'نام و نام خانوادگی سرنخ',
    'back_to_leads'                  => '← بازگشت به سرنخ‌ها',
    'no_leads_found'                 => 'هیچ سرنخی یافت نشد.',
    'no_leads_in_column'             => 'سرنخی در این وضعیت وجود ندارد.',
    'delete_lead_confirm'            => 'آیا از حذف این سرنخ مطمئنید؟',
    'lead_created_successfully'      => 'سرنخ با موفقیت ثبت شد.',
    'lead_updated_successfully'      => 'اطلاعات سرنخ با موفقیت ذخیره شد.',
    'lead_deleted_successfully'      => 'سرنخ با موفقیت حذف شد.',
    'lead_assigned_successfully'     => 'سرنخ با موفقیت تخصیص یافت.',
    'lead_followup_scheduled_successfully' => 'پیگیری بعدی با موفقیت زمان‌بندی شد.',
    'lead_status_updated_successfully' => 'وضعیت سرنخ با موفقیت به‌روزرسانی شد.',
    'lead_converted_successfully'    => 'سرنخ با موفقیت به هنرجو تبدیل شد.',
    'lead_information'               => 'اطلاعات سرنخ',
    'lead_timeline'                  => 'خط زمانی سرنخ',
    'lead_created'                   => 'ثبت سرنخ',
    'lead_last_updated'              => 'آخرین به‌روزرسانی',
    'lead_converted'                 => 'تبدیل به هنرجو',
    ...
    'assigned_admin'                 => 'مدیر مسئول',
    'unassigned'                     => 'تخصیص‌نیافته',
    'next_follow_up'                 => 'پیگیری بعدی',
    'overdue'                        => 'دیرکرد',
    'preferred_instrument'           => 'ساز مدنظر',
    'preferred_teacher'              => 'استاد مدنظر',
    'age'                            => 'سن',
    'email'                          => 'ایمیل',
    'select'                         => 'انتخاب...',
    'update_status'                  => 'به‌روزرسانی وضعیت',
    'assign_lead'                    => 'تخصیص سرنخ',
    'schedule_follow_up'             => 'زمان‌بندی پیگیری',
    'convert_lead'                   => 'تبدیل به هنرجو',
    'convert_enrollment_hint'        => 'در صورت انتخاب سطح مهارت، ثبت‌نام به‌طور خودکار ایجاد می‌شود (نیازمند ساز و استاد مدنظر).',
    'leads_kanban'                   => 'تابلوی سرنخ‌ها',
    'kanban_view'                    => 'نمای تابلویی',
    'list_view'                      => 'نمای فهرستی',
    'kanban_subtitle'                => 'پیگیری وضعیت سرنخ‌ها به‌صورت تصویری.',
    ...
    'calendar_labels' => [
        'title' => 'تقویم جلسات', 'date_loading' => 'در حال بارگذاری تاریخ', 'week_days' => 'روزهای هفته',
        'daily_schedule' => 'برنامه روزانه جلسات', 'timeline' => 'جدول زمانی جلسات', 'session_details' => 'جزئیات جلسه',
        'session_notes' => 'یادداشت جلسه', 'student' => 'هنرجو', 'teacher' => 'استاد', 'instrument' => 'ساز',
        'session_date' => 'تاریخ جلسه', 'start_time' => 'ساعت شروع', 'duration' => 'مدت', 'room' => 'اتاق', 'status' => 'وضعیت',
    ],
    'calendar_navigation' => [
        'day' => 'ناوبری روز', 'week_days' => 'انتخاب روز هفته', 'previous_day' => 'روز قبل',
        'next_day' => 'روز بعد', 'go_to_today' => 'رفتن به امروز',
    ],
    'calendar_weekdays' => [
    ...
    'calendar_states' => [
        'loading' => 'در حال بارگذاری جلسات…', 'empty' => 'جلسه‌ای برای نمایش وجود ندارد',
        'error' => 'بارگذاری تقویم با خطا مواجه شد.', 'retry' => 'تلاش دوباره', 'no_notes' => 'بدون یادداشت', 'missing_value' => '—',
    ],
    'calendar_filters' => [
        'title' => 'فیلتر جلسات', 'toggle' => 'فیلترها', 'clear_all' => 'پاک کردن همه', 'active_count' => 'تعداد فیلترهای فعال',
        'teacher' => 'استاد', 'student' => 'هنرجو', 'room' => 'اتاق', 'instrument' => 'ساز',
        'all_teachers' => 'همه استادان', 'all_students' => 'همه هنرجویان', 'all_rooms' => 'همه اتاق‌ها', 'all_instruments' => 'همه سازها',
        'by_teacher' => 'انتخاب بر اساس استاد', 'by_student' => 'انتخاب بر اساس هنرجو', 'by_room' => 'انتخاب بر اساس اتاق', 'by_instrument' => 'انتخاب بر اساس ساز',
    ],
    'calendar_errors' => [
        'loading_calendar' => 'بارگذاری تقویم با خطا مواجه شد.', 'loading_sessions' => 'خطا در بارگذاری جلسات', 'invalid_events' => 'داده‌های جلسات قابل نمایش نیستند.',
    ],
    'calendar_aria' => [
        'close_details' => 'بستن جزئیات جلسه', 'timeline' => 'جدول زمانی جلسات', 'active_filters' => 'تعداد فیلترهای فعال',
    ],
