        ...
        <aside
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-5">
                @php
                    ...
                    $isLeads       = request()->routeIs('admin.leads.*');
                ...
                <ul class="space-y-1">
                    ...
                    {{-- Leads (CRM) --}}
                    <li>
                        <a href="{{ route('admin.leads.index') }}" class="{{ $isLeads ? $navActive : $navInactive }}" :title="collapsed ? '{{ __('admin.leads') }}' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" class="{{ $isLeads ? $iconActive : $iconInactive }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 12h.007v.008H3.75V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-.375 5.25h.007v.008H3.75v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z"/></svg>
                            <span x-show="!collapsed">{{ __('admin.leads') }}</span>
                        </a>
                    </li>
                    ...
                    @if(in_array(auth()->user()?->role, [\App\Enums\RoleEnum::SUPER_ADMIN, \App\Enums\RoleEnum::ADMIN]))
                    <li>
                        <a href="{{ route('admin.users.index') }}" class="{{ $isUsers ? $navActive : $navInactive }}" :title="collapsed ? 'کاربران' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" class="{{ $isUsers ? $iconActive : $iconInactive }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/></svg>
                            <span x-show="!collapsed">کاربران</span>
                        </a>
                    </li>
                    @endif
