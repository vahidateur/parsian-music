...
<div class="mb-8">
    <h1 class="text-2xl font-semibold text-amber-100">New Enrollment</h1>
    <p class="mt-1 text-sm text-gray-500">Enroll a student with a teacher for an instrument.</p>
</div>
