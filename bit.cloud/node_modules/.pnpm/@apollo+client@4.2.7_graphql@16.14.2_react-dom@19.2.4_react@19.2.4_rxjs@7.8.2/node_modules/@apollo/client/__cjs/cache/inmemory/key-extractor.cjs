    ...
    return (info.keyFieldsFn || (info.keyFieldsFn = (object, context) => {
            ...
            const keyObject = (context.keyObject = collectSpecifierPaths(specifier, (schemaKeyPath) => {
                ...
                if (extracted === void 0 &&
                    ...
                    helpers_js_1.hasOwn.call(object, schemaKeyPath[0])) {
    ...
    return (info.keyArgsFn ||
        (info.keyArgsFn = (args, { field, variables, fieldName }) => {
            const collected = collectSpecifierPaths(specifier, (keyPath) => {
                ...
                if (firstChar === "@") {
                    if (field && (0, internal_1.isNonEmptyArray)(field.directives)) {
                        ...
                        const directiveArgs = d && (0, internal_1.argumentsObjectFromField)(d, variables);
                ...
                if (firstChar === "$") {
                    ...
                    if (variables && helpers_js_1.hasOwn.call(variables, variableName)) {
...
function getSpecifierPaths(spec) {
    ...
    if (!info.paths) {
        ...
        const currentPath = [];
        spec.forEach((s, i) => {
            if ((0, internal_1.isArray)(s)) {
                getSpecifierPaths(s).forEach((p) => paths.push(currentPath.concat(p)));
                currentPath.length = 0;
            }
            else {
                currentPath.push(s);
                if (!(0, internal_1.isArray)(spec[i + 1])) {
...
function extractKeyPath(object, path, extract) {
    ...
    return normalize(path.reduce(function reducer(obj, key) {
        return (0, internal_1.isArray)(obj) ?
...
//# sourceMappingURL=key-extractor.cjs.map
