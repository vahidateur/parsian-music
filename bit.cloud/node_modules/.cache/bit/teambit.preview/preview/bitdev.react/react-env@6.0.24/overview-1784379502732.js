...
import {defaultMainModule, bitdevReactReactEnv6024MainModule} from "/home/user/parsian-academy/node_modules/@teambit/_local/preview-modules-12abd9cc4f045f3edba053f78bfed440fef4e7ed.mjs";
async function initializeModules() {

          let file_0_0;
          if (__bitShouldSurfaceFor("parsian-music.academy/apps/parsian-profile")) {
            try {
              file_0_0 = await import("/home/user/parsian-academy/academy/apps/parsian-profile/parsian-profile.docs.mdx");
            } 
            catch (err) {
...
async function __bitMaybeInitialize(force = false, shouldNotify = false) {
  ...
  if (shouldNotify) {
    ...
    if (activePreview === "overview") {
      window.dispatchEvent(
        new CustomEvent('bit-preview-modules-updated', {
          detail: { previewName: "overview" },
        })
      );
    }
  }
...
if (__bitHot) {
  __bitHot.accept(["./academy/apps/parsian-profile/parsian-profile.docs.mdx","./node_modules/@teambit/_local/preview-modules-12abd9cc4f045f3edba053f78bfed440fef4e7ed.mjs"], () => {
